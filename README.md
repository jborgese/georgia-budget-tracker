...
| [GaDOE — Financial Data Collection System](https://financeweb.doe.k12.ga.us/FinancialPublicWeb/ReportsMenuPublic.aspx) | Current-year per-district school operating revenues (local/state/federal) and QBE FTE counts, ahead of the F-33 survey | Annual, revised as systems file through the year |
